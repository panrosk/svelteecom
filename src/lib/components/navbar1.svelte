              ...
              <div class="flex h-14 space-x-8 overflow-x-auto border-t px-4 pb-px sm:h-full sm:justify-center sm:overflow-visible sm:border-t-0 sm:pb-0">
                <div class="flex">
                  <div class="relative flex">
                    ...
                    <button type="button" on:click={handlevisibility} class="border-transparent text-gray-700 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out" aria-expanded="false">Women</button>
                  </div>
                  ...
                  {#if visible}
                     <!-- content here -->
                     <div in:fly="{{ y: 200, duration: 2000 }}" out:fly="{{ y: 200, duration: 2000 }}" class="absolute inset-x-0 top-full text-gray-500 sm:text-sm">
